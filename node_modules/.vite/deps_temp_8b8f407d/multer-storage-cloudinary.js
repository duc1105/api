...
var require_lib = __commonJS({
  "node_modules/multer-storage-cloudinary/lib/index.js"(exports) {
    ...
    var CloudinaryStorage = (
      /** @class */
      function() {
        function CloudinaryStorage2(opts) {
          var _a;
        ...
        CloudinaryStorage2.prototype._handleFile = function(req, file, callback) {
        ...
        CloudinaryStorage2.prototype._removeFile = function(req, file, callback) {
          this.cloudinary.uploader.destroy(file.filename, { invalidate: true }, callback);
        };
        CloudinaryStorage2.prototype.upload = function(opts, file) {
          var _this = this;
...
//# sourceMappingURL=multer-storage-cloudinary.js.map
