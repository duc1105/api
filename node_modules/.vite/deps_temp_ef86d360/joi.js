          ...
          for (let t4 = 0; t4 < d; ++t4) {
            ...
            for (let o3 = 0; o3 < _; ++o3) {
              ...
              if (v[o3] = f2, !f2.errors) {
                if (u2.commit(), e3[t4] = f2.value, p = true, c.fastSplice(l2, o3), --o3, --_, !r2._flags.sparse && void 0 === f2.value && (m.push(s2("array.sparse", { key: g, path: y, pos: t4, value: void 0 }, n2.localize(y))), a2.abortEarly))
                  return m;
                break;
              }
              u2.restore();
            ...
            for (const u2 of f) {
              ...
              if (-1 !== h2)
                ...
                if (l3.snapshot(), f2 = u2.$_validate(i3, l3, a2), !f2.errors) {
                  l3.commit(), "strip" === u2._flags.result ? (c.fastSplice(e3, t4), --t4, --d) : r2._flags.sparse || void 0 !== f2.value ? e3[t4] = f2.value : (m.push(s2("array.sparse", { key: g, path: y, pos: t4, value: void 0 }, n2.localize(y))), o2 = true), p = true;
                  break;
                }
                l3.restore();
              }
